...
import 'package:instagram_clone_firebase/view_modal/post_like_provider.dart';
...
class _MyPostState extends State<MyPost> {
  ...
  Widget build(BuildContext context) {
    ...
    // final myLikeProvider =
    //     Provider.of<PostLikeProvider>(context, listen: false);
    print('my post screen');
    return ChangeNotifierProvider(
      create: (_) => PostLikeProvider(postId: widget.snapshot['postId']),
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Consumer<PostLikeProvider>(builder: (context, provider, child) {
              return GestureDetector(
                onDoubleTap: () async {
                  provider.toggleLikeStatus();
                ...
                children: [
                  ...
                  Text(
                    DateFormat.yMMMd().format(
                        (widget.snapshot['datePublished'] as Timestamp)
                            .toDate()),
                    style: TextStyle(
                      color: tertiaryColor,
                    ),
